...
type ValidatedActionFunction<S extends z.ZodType<unknown>, T> = (data: z.infer<S>, formData: FormData) => Promise<T>;

export function validatedAction<S extends z.ZodType<unknown>, T>(schema: S, action: ValidatedActionFunction<S, T>) {
