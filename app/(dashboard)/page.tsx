        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div>
              ...
              <div className="mt-5">
                <h2 className="text-lg font-medium text-gray-900">Linear</h2>
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-5">
                <h2 className="text-lg font-medium text-gray-900">GitHub</h2>
                <p className="mt-2 text-base text-gray-500">
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-5">
                <h2 className="text-lg font-medium text-gray-900">Slack</h2>
                <p className="mt-2 text-base text-gray-500">
